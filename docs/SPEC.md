...
export const CONTAINER_TIMEOUT = parseInt(process.env.CONTAINER_TIMEOUT || '10800000', 10); // 3 hours default
export const IPC_POLL_INTERVAL = 1000;
export const IDLE_TIMEOUT = parseInt(process.env.IDLE_TIMEOUT || '120000', 10); // 2min — keep container alive after last result
export const FIRST_OUTPUT_TIMEOUT = parseInt(process.env.FIRST_OUTPUT_TIMEOUT || '2100000', 10); // 35min — must exceed SDK query timeout
export const MAX_CONCURRENT_CONTAINERS = Math.max(1, parseInt(process.env.MAX_CONCURRENT_CONTAINERS || '7', 10) || 7);
